...
TCI_directory = fileparts(fileparts(which('my_example_data_audio.m')));
data_file = [TCI_directory '/data/example-electrodes.mat'];
load(data_file, 'D', 't', 'S', 'chnames');

%load mat
dataMat = load('D:\Magdalena\Cottage\Cottage_session001_2021_05_06_1109.mat');
dataMat = dataMat.data(:);

%organise in proper structures

%% Cross-context correlationx

root_directory = 'D:/lab_rotations/LSP_spring_2020/myTCI';
