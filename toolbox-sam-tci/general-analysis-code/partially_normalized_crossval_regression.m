function [r2, r2_std_err, r2_smps, r, r_std_err, r_smps, Yh] = partially_normalized_crossval_regression(X,Y,nsmps)
% function [r2, r2_err, r2_smps, r, r_err, r_smps, yh] = partially_normalized_crossval_regression(X,Y,nsmps)
% 
% Calculates the correlation between predicted and measured data vectors, normalized by the 
% reliability of the data, but not the predictors. Predictions are computed using cross-validated 
...
% predict response
Yh = crossval_regression(X,mean(Y,2));
