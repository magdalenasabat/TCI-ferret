function [lineOut, fillOut] = semshade(amatrix,alpha,acolor,F,smth,method,extra)
...
if ~exist('method','var');  method='std'; end
...
amean =mean(amatrix,1,'omitnan');% nanmean(amatrix,1); %get man over first dimension
if smth > 1
