function L = myCrossCorr_latest_lfp(dat, source_folder, plot_figure, smoothing )
signalType='lfp';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% intitialise
...
for i = 1:size(dat.binned,2) % for ech channel
    ...
    ['signal-' signalType ' -- param-' dat.lfp_filterParams_str], ...
    ...
    ['signal-' signalType], ...
    ['param-' dat.lfp_filterParams_str], ...
...
%         yticks([-0.05 0 0.1 0.2]);
    ...
    t = strcat([ figureFolder filesep 'sub-' lower(dat.indiv) filesep 'sess-' dat.sessN filesep dat.taskType filesep dat.trialType filesep ... 
                                'TCI' filesep dat.signalTime filesep  signalType filesep dat.lfp_filterParams_str filesep... 
    ...
    t = strcat([ figureFolder filesep 'sub-' lower(dat.indiv) filesep 'sess-' dat.sessN filesep dat.taskType filesep dat.trialType filesep ... 
                                'testRetestCorr' filesep dat.signalTime filesep  signalType filesep dat.lfp_filterParams_str filesep... 
                                'binWidth-' num2str(dat.binWidthMs) 'ms' filesep 'eachDur'  ]);
...
figure_directory = strcat([source_folder filesep 'analysis' filesep 'figures' filesep ...
    ...
    'TCI' filesep 'stim-aligned' filesep signalType filesep dat.lfp_filterParams_str filesep 'binWidth-' num2str(dat.binWidthMs) 'ms' filesep ...
     L.param_string]);
